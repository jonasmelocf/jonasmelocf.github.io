...
import { autoComplete, fuzzyFilter, registerCompletions, completeFromList } from "prism-code-editor/autocomplete";
import { jsContext, jsCompletion, jsDocCompletion, completeKeywords, jsSnipets } from "prism-code-editor/autocomplete/javascript";
